...
public class LambdaUtil {
    ...
    public static Supplier<String> helloSupplier() {
        Supplier<String> supplier = () -> new String("Hello");//"Hello"
        return supplier;
    }
    ...
    public static Predicate<String> isEmptyPredicate() {
        Predicate<String> predicate = (s) -> s.isEmpty();//String:: isEmpty();
        return predicate;
    }
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        ...
        BiFunction<String, Integer, String> biFunction = (s, i) -> {
            String stringTemp = "";
            for (int j = 0; j < i; j++) {
                stringTemp = stringTemp.concat(s);
            }
            return stringTemp;
        };
        return biFunction;
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        ...
        Function<BigDecimal, String> function = (big) -> "$" + big;
        return function;
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        ...
        IntUnaryOperator intUnaryOperator = (i) -> (int) (Math.random() * (i + 1));
    ...
    public static ToIntFunction<String> stringToIntConverter() {
        ToIntFunction<String> function = (s) -> Integer.valueOf(s);
        return function;
    }
    ...
    public static Supplier<IntUnaryOperator> nMultiplyFunctionSupplier(int n) {
        Supplier<IntUnaryOperator> supplier = () -> (i) -> n * i;
        return supplier;
    }
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        UnaryOperator<Function<String, String>> unaryOperator = (s) -> (str) -> str.trim().toLowerCase(Locale.ROOT);
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        //todo :: extra points
        BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> biFunction = (i, p) -> {
            p = (a) -> a < 0;
            IntPredicate finalP = p;
            i = (a) -> {
                if (finalP.test(a)) {
                    return -a;
                } else {
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
        ...
        BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> biFunction = (m, s) -> {
            if (s.equalsIgnoreCase("increment")) {
                return m.get("increment");
